 ...
 *
 * Logic for converting NNF formulas to CNF and extracting clauses.
 */

import type { ASTNode } from '../types/index.js';
import { Clause, Literal, ClausifyOptions } from '../types/clause.js';
 ...
 */
export function extractClauses(node: ASTNode): Clause[] {
 ...
 */
export function nodeToLiteral(node: ASTNode): Literal {
    if (node.type === 'not') {
